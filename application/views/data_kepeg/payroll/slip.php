...
<page format="230x135" orientation="P" backtop="9mm" backbottom="2mm" backleft="2mm" backright="2mm">
    ...
    <table class="content">
        ...
        <tbody>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">Tj Overtime</td>
                <td style="border-bottom: 1px #000000 solid;text-align:right;"><?= number_format($results['FN_TUNJ_OVERTIME'], 0, ".", "."); ?></td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td style="border-bottom: 1px #000000 solid"></td>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">PTKP <?= $jk['FS_NM_ALIAS']?></td>
                <td style="border-bottom: 1px #000000 solid; text-align:right">
                  <?php

                  echo number_format($results['FN_PTKP'], 0, ".", "."); 
