    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                ...
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_PENDIDIKAN']; ?></td>
                <td style="border-bottom: 1px #000000 solid">Jabatan</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_JABATAN']; ?></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">Risiko Kerja</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_BAGIAN']; ?></td>
                <td style="border-bottom: 1px #000000 solid">Masa Kerja</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_MASA_KERJA']; ?></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">Tugas lain</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_TUGAS_LAIN']; ?></td>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">Indek Kinerja Unit</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_IKU']; ?> %</td>
                <td style="border-bottom: 1px #000000 solid">Indek Kinerja Individu</td>
                <td style="border-bottom: 1px #000000 solid"><?= $result['FS_IKI']; ?> %</td>
                <td></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td></td>
                <td colspan="2" style="border-bottom: 1px #000000 solid">Total Indek</td>
                <td colspan="2" style="border-bottom: 1px #000000 solid"><?= $result['FN_JML_IPK']; ?></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid" colspan="2">Keterangan</td>
                <td style="border-bottom: 1px #000000 solid" colspan="2"><?= $result['FS_PENGURANG_KET']; ?></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
                <td colspan="2">
                    * PKWT di terimakan 50%
                </td>
                <td></td>
            </tr>
        </tbody>
