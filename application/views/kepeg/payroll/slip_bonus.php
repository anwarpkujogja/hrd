...
<page format="230x135" orientation="P" backtop="9mm" backbottom="2mm" backleft="2mm" backright="2mm">
        ...
        <table class="page_header">
            <tr>
                <td style="width:50%;font-size: 10px;text-align: center;">
                    <div>SLIP BONUS <?= $results['FS_NM_TYPE']?> <br> Periode <?php
                    if ($results['FN_PERIODE'] == '1') {
                        echo "<b>JANUARI</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '2') {
                        echo "<b>FEBRUARI</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '3') {
                        echo "<b>MARET</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '4') {
                        echo "<b>APRIL</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '5') {
                        echo "<b>MEI</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '6') {
                        echo "<b>JUNI</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '7') {
                        echo "<b>JULI</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '8') {
                        echo "<b>AGUSTUS</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '9') {
                        echo "<b>SEPTEMBER</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '10') {
                        echo "<b>OKTOBER</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '11') {
                        echo "<b>NOVEMBER</b> " . "<b>" . date('Y') . "</b>"  ;
                    } elseif ($results['FN_PERIODE'] == '12') {
                        echo "<b>DESEMBER</b> " . "<b>" . date('Y') . "</b>"  ;
                    }
                    ?> 
                        <?= ' '.$result['TAHUN']; ?>
                    </div>
                ...
                <!--<td style="width:50%;text-align: right;">
                    <qrcode value="<?= $results['FS_KD_PEG']; ?>" ec="H" style="width: 10mm; background-color: white; color: black;"></qrcode>
    ...
    <table class="content">
        ...
        <tbody>
            <tr>
                <td></td>
                <td colspan="2" style="border-bottom: 1px #000000 solid"><b>PENGAHSILAN (A)</b></td>
            ...
            <tr>
                ...
                <td style="border-bottom: 1px #000000 solid;text-align:right;"> <b> <?= number_format($results['FN_BONUS_BRUTO'], 0, ".", "."); ?> </b> </td>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid">PTKP</td>
                <td style="border-bottom: 1px #000000 solid">:</td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td></td>
            ...
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid"><b>Bonus Bersih(C) = (A-B)</b></td>
               
                <td style="border-bottom: 1px #000000 solid;text-align:right;"> <b><?= number_format($results['FN_BONUS_BERSIH'], 0, ".", "."); ?></b> </td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
                <td style="border-bottom: 1px #000000 solid"><b>Bonus Terima Bersih (C-D)</b></td>
              
                <td style="border-bottom: 1px #000000 solid;text-align:right;"> <b><?= number_format($results['FN_BONUS_TERIMA_BERSIH'], 0, ".", "."); ?></b> </td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td style="border-bottom: 1px #000000 solid"></td>
                <td></td>
            </tr>
